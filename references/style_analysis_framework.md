...
#### 4.4 段落论证结构（深层风格）⭐ 基于导师修改版校准新增

**分析对象**：Results 节每段的内部论证结构，而非仅看段落之间的顺序。

**段落节奏模式**：
- 首句词数：___ 词（≤10 词为"短句锚点"风格）
- 首句功能：□ 核心发现陈述 / □ 过渡衔接 / □ 实验操作描述
- 首句结构："The [材料] exhibits [性能]." / "[材料] is [特性]." / 其他：___

**论证三段链识别**：
逐段标注是否包含以下三段（完整三段 / 缺少机制解释 / 仅有数据）：
1. **实验设计**："We [操作] to study/demonstrate..." → 有/无
2. **数据结果**："The results show/exhibit..." → 有/无
3. **机制解释**："This is because... / due to... / can be attributed to..." → 有/无

**主动实验叙事频率**：
- "We + 动词" 出现次数：___ 次/段
- 被动实验描述出现次数：___ 次/段
- 导师偏好：□ 主动为主 / □ 被动为主 / □ 混合（描述实验操作时主动，陈述结果时被动）

**方法精确性**：
- 是否给出测量方法说明？□ 总是 / □ 偶尔 / □ 从不
- 是否声明适用边界（"In principle... however..."）？□ 是 / □ 否
- 是否标注下界/上界估计？□ 是 / □ 否

**数据精确度分层**：
- 精确测量值标记：□ 直接数字 / □ 其他
- 近似值标记：□ ~ / □ approximately / □ about / □ around
- 估算值标记：□ approximately / □ 其他
- 边界值标记：□ lower bound / upper bound / □ 其他

**对比层次**：
- 对比参照物数量：___ 个/段
- 参照物类型：□ 同类材料 / □ 不同类别材料 / □ 天然材料 / □ 仅对照组
- 对比模板："N-fold higher than" / "surpasses that of" / "compared with" / 其他：___
